...
import { GestionarRespuestaComponent } from './feactures/gestionar-respuesta/gestionar-respuesta.component';
...
export const routes: Routes = [
    ...
    {path:'gestionarRespuesta',component:GestionarRespuestaComponent}
];
